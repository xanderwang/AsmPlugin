...
import com.xander.plugin.asm.lib.BaseClassAdapter
import com.xander.plugin.asm.lib.BaseMethodAdapter
import com.xander.plugin.asm.lib.BaseWeaverFactory
import com.xander.plugin.asm.lib.PluginConfig
import com.xander.plugin.asm.lib.URLClassLoaderHelper
...
//    this.waitableExecutor = WaitableExecutor.useGlobalSharedThreadPool()
  ...
  void applyConfig(PluginConfig config) {
    ...
    BaseClassAdapter.pluginConfig = config
    BaseMethodAdapter.pluginConfig = config
  }
