...
public class ToolMethodAdapter extends LocalVariablesSorter implements Opcodes {

  private int startVarIndex

  private String methodName

  public ToolMethodAdapter(String name, int access, String desc, MethodVisitor mv) {
...
//    }
  ...
  void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
    println "visitMethodInsn owner:${owner},name:${name}"
